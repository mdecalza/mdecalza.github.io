    ...
    return (
        ...
        className='container-xxl'>
            ...
            className='px-4 pb-4'>
                ...
                <br/>
                Though quite amateur, my first songs <a href="https://open.spotify.com/track/66LjOq1s89FIYDqgZxqRNS"><i>Strangest Ways</i></a> and <a href="https://open.spotify.com/track/52roInbjZuFBqzE9Av26rY"><i>Space and Time (Unkillable Nature)</i></a> showcased my obsession with lofi, bedroom pop, rap, and musical experimentation. This eclectic combination of sounds coalesced into my maligned mixtape debut, <i>Deibyu</i>. However mixed the tape, <i>Deibyu</i> was a huge accomplishment for me as an musician, and marked my first of many collaborations with &quot;Shreds&quot; Abrahamson and Josh Jacquot.<br/>
                <br/>
                ...
                <br/>
                As 2019 was coming to an end, I began experimenting with heavier samples and more ambitious production. The <a href="https://soundcloud.com/sontomorio/sets/midnight-movies"><i>Midnight Movies</i></a> mixtape was released in December 2019, showcasing more overtly my taste for humorous samples and light, funky hip-hop. The latter half of the record featured more original compositions, however, leading to the release of the singles <a href="https://open.spotify.com/track/3fUzaulddG1m6Hs6ai625V"><i>Golden Eyes</i></a>, <a href="https://open.spotify.com/track/0OEEx55wjjRIplhi5q6tUo"><i>When We Make It</i></a>, and <a href="https://open.spotify.com/track/3fVkJbVtt1EOEtvPm3cJRe"><i>The Forest Spirits</i></a>.<br/>
                <br/>
                I still experiment with new sounds into the 2020s, releasing new music on <a href="https://www.youtube.com/channel/UCPeP7F5d_NSwuAxlEMr3ukQ">YouTube</a> and <a href="https://soundcloud.com/sontomorio">SoundCloud</a>. The mix EP <a href="https://soundcloud.com/sontomorio/sets/sonto-iv"><i>Sonto IV</i></a> (2020) showcases some of my most abrasive hip-hop production yet, while the beattapes <a href="https://soundcloud.com/sontomorio/sets/the-freeway"><i>The Freeway</i></a> (2021) and <a href="https://soundcloud.com/sontomorio/sets/sontoolegio"><i>Sonto&apos;olegio</i></a> (2022) each feature more lo-fi production over a variety of genres.
            </p>
        </div>
    );
}